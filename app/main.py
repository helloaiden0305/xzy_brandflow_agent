...
app = FastAPI(
    ...
    description="""
## XZY BrandFlow Agent API

面向企业品牌、HR、运营、行政和管理团队的宣传内容生成与审核工作流服务，适用于外部公众号、内部宣发平台、内部招聘平台、官网公示等企业宣传场景。

### 核心功能

- **主题策划**: AI 根据宣传方向生成多个候选宣传主题
- **初稿撰写**: AI 根据选定主题生成宣传初稿
- **人工审核**: 支持通过/驳回机制，驳回后可重写
- **传播素材生成**: 自动提取视觉摘要并生成传播素材
- **场景覆盖**: 支持活动复盘、技术成果宣传、组织文化宣传、招聘宣传等内容流转
