...
class Settings(BaseSettings):
    ...
    # 应用配置
    app_name: str = "XZY BrandFlow Agent"
    debug: bool = True
    
    # 数据库配置 (SQLAlchemy AsyncIO)
    database_url: str = "postgresql+asyncpg://postgres:password@localhost:5432/brandflow_db"
    
    # PostgreSQL 连接配置 (psycopg3 / LangGraph Checkpointer)
    postgres_uri: str = "postgresql://postgres:password@localhost:5432/brandflow_db"
