...
def build_workflow_graph() -> StateGraph:
    ...
    工作流逻辑：
    1. Start -> topic_selection (主题策划子图：AI 生成主题 + 人工选择主题)
    2. topic_selection -> write_draft (AI 写宣传初稿)
    ...
    # 添加节点
    # 使用子图作为节点：将主题策划相关逻辑封装为 topic_selection 子图
